            ...
            <View style={tw`px-4 py-6`}>
                ...
                <View style={tw`mb-6 w-full`}>
                    ...
                    <View style={tw`flex-row items-center justify-between w-full`}>
                        ...
                        >
                            <View style={tw`h-32 w-[${width * 0.42}px] rounded-3xl bg-white border-2 border-purple-200 mb-4 dark:border-0`}>
                            </View>
                        ...
                        <TouchableOpacity 
                            ...
                            style={tw`items-center`}
                        >
                            <View style={tw`h-32 w-[${width * 0.42}px] rounded-3xl bg-gray-500 dark:border-2 dark:border-purple-200 mb-4`}>
                            </View>
